...
```bash pnpm
pnpx shadcn-svelte@latest add https://sv-animations.vercel.app/r/animated-shiny-text
```

```bash bun
bunx shadcn-svelte@latest add https://sv-animations.vercel.app/r/animated-shiny-text
```
