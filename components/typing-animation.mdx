...
```bash npm
npx shadcn-svelte@latest add https://magicui.acme.com/r/typing-animation
```

```bash pnpm
pnpx shadcn-svelte@latest add https://magicui.acme.com/r/typing-animation
```

```bash bun
bunx shadcn-svelte@latest add https://magicui.acme.com/r/typing-animation
```
