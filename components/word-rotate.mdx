...
```bash npm
npx shadcn-svelte@latest add https://magicui.acme.com/r/word-rotate
```

```bash pnpm
pnpx shadcn-svelte@latest add https://magicui.acme.com/r/word-rotate
```

```bash bun
bunx shadcn-svelte@latest add https://magicui.acme.com/r/word-rotate
```
