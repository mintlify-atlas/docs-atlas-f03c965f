...
```bash pnpm
pnpx shadcn-svelte@latest add https://sv-animations.vercel.app/r/text-animate
```

```bash bun
bunx shadcn-svelte@latest add https://sv-animations.vercel.app/r/text-animate
```
